...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Johnny Sins";
...
var typed = new Typed(".typing-text", {
    strings: ["youtuber", "adult entertainment", "OnlyFans", "Man of the Year"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
async function fetchData(type = "skills") {
    let response
    type === "skills" ?
        response = await fetch("newSkills.json")
        :
...
function showSkills(skills) {
    ...
    skills.forEach(skill => {
        ...
        <div class="bar">
              <div class="info">
                <img src=${skill.icon_img} alt="skill" width="96" height="96" />
